---
date: 2026-05-14
tags: [skill, debug, prototype, design, matt, pocock, ia, tecnologia, automacao]
moc: "[[MOC-Skills]]"
---
# Mp Prototype

Constrói protótipo descartável para validar design antes de commitar. Duas rotas: app terminal (state/business-logic) ou variações de UI toggleáveis.

## Quando usar
"prototype this", "let me play with it", "try a few designs", "quero jogar com isso", "tenta alguns designs", validar modelo de dados ou state machine antes de implementar.
...
## Notas Relacionadas
[[Debug-Dev/Mp TDD]] · [[Matt-Pocock/Mp Prototype]]
