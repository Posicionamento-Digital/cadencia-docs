...
| **VPS Hostinger** `72.60.4.71` | Ambiente de desenvolvimento do Luiz |
...
### `/ver-dia-luiz [data]`
Mostra o que Luiz fez num dia específico:
...
## 5. Skills de gestão — Luiz (na VPS)

### `/start-issue [PDL-XX]`
1. Busca issues atribuídas ao Luiz no Linear
2. Apresenta lista por prioridade
3. Luiz escolhe qual começar
...
4. Atribuir todas ao Luiz
5. Linkar o repo GitHub em cada issue

---

## 7. Ambiente de trabalho do Luiz
...
| Fim do dia | Felipe | `/ver-dia-luiz` — o que Luiz fez |
...
6. Avisa o Luiz que as issues estão prontas

**Resultado:** issues criadas, atribuídas, com label de repo e epic corretas.

---

### Cenário B: Luiz começa o dia de trabalho
...
1. A skill lista todas as issues atribuídas ao Luiz por prioridade
2. Luiz digita o número ou o identificador (ex: `PDL-58`)
3. A skill:
   - Faz `git fetch` + `git checkout -b luiz/pdl-58-descricao`
   - Marca a issue como **In Progress** no Linear
4. Luiz começa a implementar

---

### Cenário C: Luiz implementa e commita
...
### Cenário D: Luiz fecha uma issue
...
### Cenário E: Felipe acompanha o dia do Luiz
...
2. Cria issue no time **Posicionamento Digital**
...
Resultado:
- O que Luiz entregou na semana
- O que está em andamento
- O que atrasou (com justificativa se houver)

---

### Cenário J: Luiz precisa de ajuda técnica

Luiz usa Claude Code diretamente na VPS:
